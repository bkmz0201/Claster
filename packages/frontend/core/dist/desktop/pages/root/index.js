...
export const RootWrapper = () => {
    ...
    return (_jsxs(FrameworkScope, { scope: defaultServerService.server.scope, children: [_jsx(GlobalDialogs, {}), _jsx(NotificationCenter, {}), _jsx(Outlet, {}), _jsx(CustomThemeModifier, {}), BUILD_CONFIG.isElectron && _jsx(FindInPagePopup, {})] }));
};
