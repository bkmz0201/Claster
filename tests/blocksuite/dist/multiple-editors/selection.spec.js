...
import { enterPlaygroundRoom, initEmptyParagraphState, initThreeParagraphs, } from '../utils/actions/misc.js';
import { getRichTextBoundingBox } from '../utils/actions/selection.js';
import { test } from '../utils/playwright.js';
test('should only show one format bar when multiple editors are toggled', async ({ page, }) => {
    ...
    const formatBar = page.locator('affine-toolbar-widget editor-toolbar[data-open]');
