...
export async function expandCollapsibleSection(page, name) {
    ...
    const section = divider.locator('~ [data-testid="collapsible-section-content"]');
 ...
 * Click header "<" button
 */
export async function pageBack(page) {
    await page.getByTestId('page-header-back').tap();
}
export async function getAttrOfActiveElement(page, attrName = 'data-testid') {
 ...
 */
export async function openNavigationPanelNodeMenu(page, node) {
