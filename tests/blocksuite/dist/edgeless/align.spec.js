...
import { addBasicBrushElement, createConnectorElement, createFrameElement, createNote, createShapeElement, setEdgelessTool, Shape, toViewCoord, triggerComponentToolbarAction, } from '../utils/actions/edgeless.js';
import { clickView, edgelessCommonSetup as commonSetup, selectAllByKeyboard, type, waitNextFrame, } from '../utils/actions/index.js';
import { assertEdgelessSelectedModelRect, getSelectedRect, } from '../utils/asserts.js';
...
test.describe('auto arrange align', () => {
    test('arrange shapes', async ({ page }) => {
        ...
        await createShapeElement(page, [0, 200], [100, 300], Shape['Rounded rectangle']);
    ...
    test('arrange shape, note, connector, brush and edgeless text', async ({ page, }) => {
        await commonSetup(page);
        // shape
        await createShapeElement(page, [0, 0], [100, 100], Shape.Square);
...
test.describe('auto resize align', () => {
    ...
    test('resize and arrange shape, note, connector, brush and text', async ({ page, }) => {
        await commonSetup(page);
        // shape
        await createShapeElement(page, [0, 0], [100, 100], Shape.Square);
        await createShapeElement(page, [150, 150], [300, 300], Shape.Ellipse);
