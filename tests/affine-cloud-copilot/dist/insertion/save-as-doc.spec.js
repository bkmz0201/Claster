...
test.describe('AIInsertion/SaveAsDoc', () => {
    ...
    test('should save content as a doc in page mode', async ({ loggedInPage: page, utils, }) => {
        await utils.chatPanel.openChatPanel(page);
        ...
        const { actions, content } = await utils.chatPanel.getLatestAssistantMessage(page);
    ...
    test('should save content as a doc in edgeless mode', async ({ loggedInPage: page, utils, }) => {
...
//# sourceMappingURL=save-as-doc.spec.js.map