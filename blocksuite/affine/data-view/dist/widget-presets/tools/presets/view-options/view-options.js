...
import { ArrowRightSmallIcon, DeleteIcon, DuplicateIcon, FilterIcon, GroupingIcon, InfoIcon, LayoutIcon, MoreHorizontalIcon, SortIcon, } from '@blocksuite/icons/lit';
...
import { popGroupSetting, popSelectGroupByProperty, } from '../../../../core/group-by/setting.js';
import { groupTraitKey } from '../../../../core/group-by/trait.js';
import { emptyFilterGroup, popCreateFilter, renderUniLit, } from '../../../../core/index.js';
...
const createSettingMenus = (target, dataViewLogic, reopen, closeMenu) => {
            ...
            select: () => {
                ...
                if (!groupBy) {
                    popSelectGroupByProperty(target, groupTrait, {
                        onSelect: () => popGroupSetting(target, groupTrait, reopen, closeMenu, [
                            autoPlacement({
                                allowedPlacements: ['bottom-start', 'top-start'],
                            }),
                            offset({ mainAxis: 15, crossAxis: -162 }),
