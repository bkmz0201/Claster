...
export function App() {
    return (_jsx(FrameworkRoot, { framework: frameworkProvider, children: _jsx(ThemeProvider, { children: _jsx(I18nProvider, { children: _jsx("div", { className: styles.root, "data-is-windows": environment.isWindows, children: mode === 'recording' && _jsx(Recording, {}) }) }) }) }));
}
