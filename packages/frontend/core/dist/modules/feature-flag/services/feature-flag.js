...
let FeatureFlagService = (() => {
    let _classDecorators = [OnEvent(ApplicationStarted, e => e.setupRestartListener)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = Service;
    var FeatureFlagService = class extends _classSuper {
        static { _classThis = this; }
        constructor() {
            super(...arguments);
            this.flags = this.framework.createEntity(Flags);
        }
        static {
