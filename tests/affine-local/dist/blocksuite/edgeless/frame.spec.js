...
import { clickEdgelessModeButton, clickView, createEdgelessNoteBlock, dragView, locateEditorContainer, locateToolbar, toViewCoord, } from '@affine-test/kit/utils/editor';
import { pressBackspace, pressEscape, selectAllByKeyboard, } from '@affine-test/kit/utils/keyboard';
...
test('should update zindex of element when moving it into frame', async ({ page, }) => {
