...
function getEdgelessTextColor(text) {
    return text
...
test('should update color of edgeless text when switching theme', async ({ page, }) => {
    const container = locateEditorContainer(page);
    ...
    const pickedColorButton = colorPicker.locator('edgeless-color-button[active]');
