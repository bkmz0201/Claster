...
export const TranscriptionBlock = ({ block, }) => {
    const childMap$ = useMemo(() => LiveData.fromSignal(block.childMap), [block.childMap]);
    ...
    return (_jsx("div", { className: styles.root, 
        // draggable + onDragStart to blacklist blocksuite's default drag behavior for attachment block
        draggable: "true", onDragStart: onDragStart, children: _jsx(AdaptedTranscriptionBlock, { blockId: block.id }) }));
};
//# sourceMappingURL=transcription-block.js.map