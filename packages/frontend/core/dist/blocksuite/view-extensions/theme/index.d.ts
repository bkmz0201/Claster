...
export declare class AffineThemeViewExtension extends ViewExtensionProvider<AffineThemeViewOptions> {
    name: string;
    schema: z.ZodObject<{
        framework: z.ZodOptional<z.ZodType<FrameworkProvider, z.ZodTypeDef, FrameworkProvider>>;
    }, "strip", z.ZodTypeAny, {
    ...
    setup(context: ViewExtensionContext, options?: AffineThemeViewOptions): void;
}
export {};
