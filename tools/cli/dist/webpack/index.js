...
export function createHTMLTargetConfig(pkg, entry, htmlConfig = {}, deps) {
    ...
    const config = {
        ...
        resolve: {
            ...
            alias: {
                ...
                '@preact/signals-core': ProjectRoot.join('node_modules', '@preact', 'signals-core').value,
            },
        },
        //#endregion
        ...
        plugins: compact([
            ...
            new webpack.DefinePlugin({
                ...
                ...Object.entries(buildConfig).reduce((def, [k, v]) => {
...
export function createWorkerTargetConfig(pkg, entry) {
    ...
    return {
        ...
        plugins: compact([
            new webpack.DefinePlugin(Object.entries(buildConfig).reduce((def, [k, v]) => {
                def[`BUILD_CONFIG.${k}`] = JSON.stringify(v);
                return def;
            }, {})),
...
export function createNodeTargetConfig(pkg, entry) {
    return {
        name: entry,
        context: ProjectRoot.value,
        experiments: {
