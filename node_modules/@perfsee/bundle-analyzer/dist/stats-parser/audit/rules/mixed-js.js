...
exports.mixedJs = void 0;
const stats_1 = require("../../../stats");
const utils_1 = require("../utils");
function isMixedAsset(asset) {
    ...
    asset.modules.forEach((m) => {
        ...
        const isSourceCode = m.path === stats_1.SOURCE_CODE_PATH;
        sourceCodeExists = sourceCodeExists || m.path === stats_1.SOURCE_CODE_PATH;
        const concatenatingModules = m.concatenating.filter((concatenated) => concatenated.path !== m.path && !concatenated.ignored);
        libsExist = libsExist || !isSourceCode || (isSourceCode && concatenatingModules.length !== 0);
    });
    return sourceCodeExists && libsExist;
}
const mixedJs = ({ assets }) => {
    const mixedAssets = [];
...
Separate them to achieve better long term predictable cache.`,
        ...
        score: (0, utils_1.rangeScore)(mixedAssets.length, 0, 3),
        numericScore: {
...
exports.mixedJs = mixedJs;
//# sourceMappingURL=mixed-js.js.map