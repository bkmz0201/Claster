...
test.describe('AIAction/Translate', () => {
    ...
    test('should support translating the selected content', async ({ loggedInPage: page, utils, }) => {
    ...
    test('should support translating the selected text block in edgeless', async ({ loggedInPage: page, utils, }) => {
        const { translate } = await utils.editor.askAIWithEdgeless(page, async () => {
    ...
    test('should support translating the selected note block in edgeless', async ({ loggedInPage: page, utils, }) => {
        const { translate } = await utils.editor.askAIWithEdgeless(page, async () => {
