...
export interface WorkspaceFlavourProvider {
    ...
    createWorkspace(initial: (docCollection: BSWorkspace, blobStorage: BlobStorage, docStorage: DocStorage) => Promise<void>): Promise<WorkspaceMetadata>;
...
export declare const WorkspaceFlavoursProvider: import("@toeverything/infra").Identifier<WorkspaceFlavoursProvider> & ((variant: string) => import("@toeverything/infra").Identifier<WorkspaceFlavoursProvider>);
