...
import { IconButton, MenuItem, MenuSeparator, useConfirmModal, } from '@affine/component';
    ...
    return useMemo(() => [
        {
            index: 0,
            inline: true,
            view: (_jsx(IconButton, { size: "16", "data-testid": "collection-add-doc-button", onClick: handleAddDocToCollection, tooltip: t['com.affine.rootAppSidebar.explorer.collection-add-tooltip'](), children: _jsx(PlusIcon, {}) })),
        },
        {
            index: 103,
        ...
        {
            index: 10000,
            view: (_jsx(MenuItem, { type: 'danger', prefixIcon: _jsx(DeleteIcon, {}), "data-testid": "collection-delete-button", onClick: handleDeleteCollection, children: t['Delete']() })),
        },
    ], [
        favorite,
