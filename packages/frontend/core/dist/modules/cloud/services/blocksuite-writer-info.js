 ...
 */
let BlocksuiteWriterInfoService = (() => {
    let _classDecorators = [OnEvent(WorkspaceInitialized, i => i.onWorkspaceInitialized)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = Service;
    var BlocksuiteWriterInfoService = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            BlocksuiteWriterInfoService = _classThis = _classDescriptor.value;
        ...
        onWorkspaceInitialized(workspace) {
            ...
            const subscription = workspace.docCollection.meta.docMetaAdded.subscribe(docId => {
    ...
    return BlocksuiteWriterInfoService = _classThis;
})();
export { BlocksuiteWriterInfoService };
//# sourceMappingURL=blocksuite-writer-info.js.map