...
import { createShapeElement, dragBetweenViewCoords, edgelessCommonSetup, getFirstContainerId, locatorComponentToolbar, Shape, shiftClickView, triggerComponentToolbarAction, } from '../../utils/actions/edgeless.js';
import { pressBackspace, redoByKeyboard, selectAllByKeyboard, SHORT_KEY, undoByKeyboard, } from '../../utils/actions/keyboard.js';
import { captureHistory } from '../../utils/actions/misc.js';
import { assertCanvasElementsCount, assertContainerChildCount, assertContainerIds, assertEdgelessNonSelectedRect, assertSelectedBound, } from '../../utils/asserts.js';
...
test.describe('group', () => {
    ...
    test.describe('group create', () => {
        ...
        test('create group button not show when single select', async ({ page, }) => {
