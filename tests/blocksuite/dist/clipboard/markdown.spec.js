import { enterPlaygroundRoom, focusRichText, initEmptyParagraphState, pasteContent, resetHistory, undoByClick, waitEmbedLoaded, waitNextFrame, } from '../utils/actions/index.js';
import { assertBlockTypes, assertRichImage, assertRichTexts, assertTextFormats, } from '../utils/asserts.js';
...
test(scoped `clipboard paste HTML containing markdown syntax code and image `, async ({ page }) => {
