...
interface DateTimePickerBaseProps extends ActionProps, AutoFocusibleProps, ConfirmableProps {
    children?: never;
    /**
 ...
 */
export declare const DateTimePicker: BuiltInComponent<DateTimePickerProps>;
export {};
