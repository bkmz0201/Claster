...
import { OpenDocExtension, } from '@blocksuite/affine/shared/services';
import { CenterPeekIcon, ExpandFullIcon, OpenInNewIcon, SplitViewIcon, } from '@blocksuite/icons/lit';
export const openDocActions = [
    {
...
].filter((a) => a.enabled && EditorSettingSchema.shape.openDocMode.safeParse(a.type).success);
export function patchOpenDocExtension() {
    const openDocConfig = {
        items: openDocActions.map(({ type, label, icon }) => ({
            type,
            label,
            icon,
        })),
...
//# sourceMappingURL=open-doc.js.map