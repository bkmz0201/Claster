...
let ChatPanelCollectionChip = (() => {
    ...
    return class ChatPanelCollectionChip extends _classSuper {
        constructor() {
            super(...arguments);
            ...
            this.#collection_accessor_storage = (__runInitializers(this, _removeChip_extraInitializers), __runInitializers(this, _collection_initializers, void 0));
            this.onChipDelete = (__runInitializers(this, _collection_extraInitializers), () => {
        ...
        static {
            ...
            _collection_decorators = [property({ attribute: false })];
            ...
            __esDecorate(this, null, _collection_decorators, { kind: "accessor", name: "collection", static: false, private: false, access: { has: obj => "collection" in obj, get: obj => obj.collection, set: (obj, value) => { obj.collection = value; } }, metadata: _metadata }, _collection_initializers, _collection_extraInitializers);
        ...
        #collection_accessor_storage;
        get collection() { return this.#collection_accessor_storage; }
        set collection(value) { this.#collection_accessor_storage = value; }
        render() {
...
export { ChatPanelCollectionChip };
//# sourceMappingURL=collection-chip.js.map