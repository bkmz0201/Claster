...
import { DefaultServerService, WorkspaceServerService, } from '@affine/core/modules/cloud';
import { GlobalContextService } from '@affine/core/modules/global-context';
import { PeekViewManagerModal } from '@affine/core/modules/peek-view';
import { WorkspacesService } from '@affine/core/modules/workspace';
import { FrameworkScope, LiveData, useLiveData, useServices, } from '@toeverything/infra';
import { useEffect, useLayoutEffect, useMemo, useState, } from 'react';
import { map } from 'rxjs';
import { AppFallback } from '../../components/app-fallback';
import { WorkspaceDialogs } from '../../dialogs';
export const WorkspaceLayout = ({ meta, children, }) => {
    // todo: reduce code duplication with packages\frontend\core\src\pages\workspace\index.tsx
    const { workspacesService, globalContextService, defaultServerService } = useServices({
        WorkspacesService,
    ...
    if (!isRootDocReady) {
        return _jsx(AppFallback, {});
    }
    return (_jsx(FrameworkScope, { scope: workspaceServer?.scope, children: _jsx(FrameworkScope, { scope: workspace.scope, children: _jsx(AffineErrorBoundary, { height: "100dvh", children: _jsxs(SWRConfigProvider, { children: [_jsx(WorkspaceDialogs, {}), _jsx(PeekViewManagerModal, {}), _jsx(AiLoginRequiredModal, {}), _jsx(uniReactRoot.Root, {}), _jsx(WorkspaceSideEffects, {}), children] }) }) }) }));
};
