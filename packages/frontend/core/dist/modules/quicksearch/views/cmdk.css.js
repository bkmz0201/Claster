...
globalStyle(`${root} [cmdk-item][data-selected=true][data-is-danger=true] ${itemIcon}`, {
    color: cssVar('errorColor'),
});
globalStyle(`${root} [cmdk-item][data-selected=true][data-is-danger=true] ${itemLabel}`, {
    color: cssVar('errorColor'),
});
...
//# sourceMappingURL=cmdk.css.js.map