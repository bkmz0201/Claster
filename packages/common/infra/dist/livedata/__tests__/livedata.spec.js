...
describe('livedata', () => {
    ...
    test('poisoned', () => {
        {
            let subscriber = null;
            const livedata$ = LiveData.from(new Observable(sub => {
                subscriber = sub;
            }), 1);
            let value = 0;
            let error = null;
    ...
    test('flat', () => {
        ...
        {
            const wrapped$ = new LiveData(new LiveData([
    ...
    test('computed', () => {
        ...
        }
        {
            ...
            let count = 0;
            let subscriber = null;
            const a$ = LiveData.from(new Observable(sub => {
                count++;
                watched = true;
                subscriber = sub;
                sub.next(1);
...
//# sourceMappingURL=livedata.spec.js.map