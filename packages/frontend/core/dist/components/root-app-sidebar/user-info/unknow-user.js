...
export const UnknownUserIcon = memo(({ width = 20, height = 20 }) => {
  ...
  <defs>
    ...
    return (_jsx("div", { style: { lineHeight: 0 }, dangerouslySetInnerHTML: { __html: svgRaw } }));
});
UnknownUserIcon.displayName = 'UnknownUserIcon';
//# sourceMappingURL=unknow-user.js.map