...
exports.getPackageMeta = exports.resolveNodeModulePath = exports.trimModuleName = void 0;
const path_1 = require("path");
const query_string_1 = require("query-string");
const stats_1 = require("./stats");
function trimModuleName(raw) {
    let nameCandidate = '';
    ...
    for (let i = 0; i < raw.length; i++) {
        ...
        if (ch === '!') {
            ...
            const page = (0, query_string_1.parse)(raw.substr(i + 1)).page;
            if (page) {
                nameCandidate = page;
                break;
            }
...
exports.trimModuleName = trimModuleName;
function allIndexesOf(source, match) {
    const indexes = [];
 ...
 * }
 */
function resolveNodeModulePath(fullPath, rootPath) {
...
function getPackageMeta(modulePath, repoPath, buildPath) {
    // `fs (ignored)`
    ...
    return {
        name: isWebpackInternal ? stats_1.WEBPACK_INTERNAL_PATH : stats_1.SOURCE_CODE_PATH,
        path: isWebpackInternal ? stats_1.WEBPACK_INTERNAL_PATH : stats_1.SOURCE_CODE_PATH,
    };
}
exports.getPackageMeta = getPackageMeta;
function resolvePathFunctions(test) {
    if (test.startsWith('/')) {
        return path_1.posix;
    }
    return /\\/.test(test) ? path_1.win32 : path_1.posix;
}
