...
import { copyByKeyboard, pasteByKeyboard, pressArrowDown, pressArrowUp, pressEnter, pressEscape, type, } from '../utils/actions/keyboard.js';
import { enterPlaygroundRoom, focusRichText, getBoundingBox, initDatabaseDynamicRowWithData, initDatabaseRowWithData, initEmptyDatabaseState, initEmptyDatabaseWithParagraphState, waitNextFrame, } from '../utils/actions/misc.js';
import { assertRichTexts } from '../utils/asserts.js';
import { test } from '../utils/playwright.js';
import { assertDatabaseTitleColumnText, getDatabaseCell, getElementStyle, initDatabaseColumn, switchColumnType, } from './actions.js';
test.describe('copy&paste when editing', () => {
    test.skip('should support copy&paste of the title column', async ({ page, }) => {
