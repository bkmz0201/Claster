...
import { embedSyncedDocMiddleware, PlainTextAdapter, } from '@blocksuite/affine-shared/adapters';
    ...
    describe('embed link block', () => {
        const embedTestCases = [
            ...
            },
            {
                ...
                plainText: '[example github pr title](https://github.com/toeverything/blocksuite/pull/66666)\n',
            },
            {
                name: 'embed figma',
        ...
        test('linked doc block', async () => {
            ...
            const plainText = 'test: https://example.com/4T5ObMgEIMII-4Bexyta1?mode=page&blockIds=abc%2C123&elementIds=def%2C456&databaseId=deadbeef&databaseRowId=123\n';
            const plainTextAdapter = new PlainTextAdapter(createJob([middleware]), provider);
            const target = await plainTextAdapter.fromBlockSnapshot({
                snapshot: blockSnapShot,
            });
...
//# sourceMappingURL=plain-text.unit.spec.js.map