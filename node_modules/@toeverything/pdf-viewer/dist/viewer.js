...
export class Viewer {
     ...
     */
    async openWithBlob(blob, password) {
     ...
     */
    createBitmap(width, height, alpha) {
     ...
     */
    createBitmapWith(width, height, format = Bitmap.format, firstScan, stride) {
        const ptr = this.runtime.createBitmapWith(width, height, format, firstScan, stride);
