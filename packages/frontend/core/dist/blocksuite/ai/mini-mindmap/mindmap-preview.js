...
import { MindmapStyleFour, MindmapStyleOne, MindmapStyleThree, MindmapStyleTwo, } from '@blocksuite/affine/gfx/mindmap';
...
let MiniMindmapPreview = (() => {
  ...
  `; }
        ...
        _createTemporaryDoc() {
            ...
            const surface = doc.getModelById(surfaceId);
            doc.resetHistory();
            return {
                doc,
                surface,
...
export const markdownToMindmap = (answer, doc, provider) => {
    let result = null;
