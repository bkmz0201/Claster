...
import { enterPlaygroundRoom, getAddRow, initEmptyDatabaseState, waitNextFrame, } from '../utils/actions/misc.js';
import { test } from '../utils/playwright.js';
import { changeColumnType, moveToCenterOf, press, pressKey, } from './actions.js';
const addRow = async (page, count = 1) => {
...
const insertRightColumn = async (page, index = 0) => {
    await waitNextFrame(page);
...
const menuSelect = async (page, selectors) => {
    await waitNextFrame(page);
...
//# sourceMappingURL=statistics.spec.js.map