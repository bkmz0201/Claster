...
export function App() {
    return (_jsx(Suspense, { children: _jsx(FrameworkRoot, { framework: frameworkProvider, children: _jsx(I18nProvider, { children: _jsx(AffineContext, { store: getCurrentStore(), children: _jsx(RouterProvider, { fallbackElement: _jsx(AppFallback, {}), router: router, future: future }) }) }) }) }));
}
