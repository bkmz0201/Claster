...
import { createRandomUser, deleteUser, enableCloudWorkspace, loginUser, } from '@affine-test/kit/utils/cloud';
...
test('open in app card should be shown for cloud workspace', async ({ page, }) => {
...
//# sourceMappingURL=open-in-app.spec.js.map