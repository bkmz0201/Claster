...
import { addBasicRectShapeElement, deleteAll, getNoteBoundBoxInEdgeless, setEdgelessTool, switchEditorMode, } from '../utils/actions/edgeless.js';
import { enterPlaygroundRoom, initEmptyEdgelessState, } from '../utils/actions/misc.js';
import { assertBlockCount, assertEdgelessNonSelectedRect, } from '../utils/asserts.js';
...
test('erase note', async ({ page }) => {
    ...
    await dragBetweenCoords(page, { x: 0, y: 0 }, { x: box.x + 10, y: box.y + 10 });
    await assertBlockCount(page, 'edgeless-note', 0);
});
//# sourceMappingURL=eraser.spec.js.map