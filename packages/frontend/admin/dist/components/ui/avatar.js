...
const AvatarImage = React.forwardRef(({ className, ...props }, ref) => (_jsx(AvatarPrimitive.Image, { ref: ref, crossOrigin: "anonymous", className: cn('aspect-square h-full w-full', className), ...props })));
