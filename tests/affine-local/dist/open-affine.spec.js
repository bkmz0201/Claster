...
test('Download client tip', async ({ page }) => {
    ...
    const closeButton = page.locator('[data-testid=local-demo-tips-close-button]');
    await closeButton.click();
    await expect(localDemoTipsItem).not.toBeVisible();
    await page.reload();
    const currentLocalDemoTipsItemItem = page.locator('[data-testid=local-demo-tips]');
    await expect(currentLocalDemoTipsItemItem).toBeVisible();
});
//# sourceMappingURL=open-affine.spec.js.map