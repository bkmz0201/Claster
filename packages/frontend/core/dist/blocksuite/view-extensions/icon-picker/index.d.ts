...
export declare class AffineIconPickerExtension extends ViewExtensionProvider<AffineIconPickerViewOptions> {
    name: string;
    schema: z.ZodObject<{
        framework: z.ZodOptional<z.ZodType<FrameworkProvider, z.ZodTypeDef, FrameworkProvider>>;
    }, "strip", z.ZodTypeAny, {
    ...
    setup(context: ViewExtensionContext, options?: AffineIconPickerViewOptions): void;
}
export {};
