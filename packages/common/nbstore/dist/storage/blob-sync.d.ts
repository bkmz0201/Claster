...
export declare abstract class BlobSyncStorageBase implements BlobSyncStorage {
    readonly storageType = "blobSync";
    abstract readonly connection: Connection;
    abstract setBlobUploadedAt(peer: string, blobId: string, uploadedAt: Date | null): Promise<void>;
    abstract getBlobUploadedAt(peer: string, blobId: string): Promise<Date | null>;
}
