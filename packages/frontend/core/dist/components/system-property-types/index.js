import { CloudWorkspaceIcon, DateTimeIcon, EdgelessIcon, FavoriteIcon, HistoryIcon, IntegrationsIcon, LongerIcon, MemberIcon, TagIcon, TemplateIcon, TitleIcon, } from '@blocksuite/icons/rc';
import { DateFilterMethod } from '../workspace-property-types';
import { CreateAtDocListProperty, CreatedAtFilterValue, CreatedAtGroupHeader, UpdatedAtDocListProperty, UpdatedAtFilterValue, UpdatedAtGroupHeader, } from './created-updated-at';
import { CreatedByDocListInlineProperty, CreatedByUpdatedByFilterValue, ModifiedByGroupHeader, UpdatedByDocListInlineProperty, } from './created-updated-by';
import { EdgelessThemeDocListProperty, EdgelessThemeFilterValue, EdgelessThemeGroupHeader, } from './edgeless-theme';
import { FavoriteFilterValue } from './favorite';
import { IntegrationTypeDocListProperty, IntegrationTypeFilterValue, IntegrationTypeGroupHeader, } from './integration-type';
import { PageWidthDocListProperty, PageWidthFilterValue, PageWidthGroupHeader, } from './page-width';
import { SharedFilterValue } from './shared';
import { TagsDocListProperty, TagsFilterValue, TagsGroupHeader } from './tags';
import { TemplateDocListProperty, TemplateFilterValue, TemplateGroupHeader, } from './template';
...
export const isSupportedSystemPropertyType = (type) => {
