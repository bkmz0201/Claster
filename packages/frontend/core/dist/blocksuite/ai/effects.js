...
import { AIChatBlockMessage, AIChatBlockMessages, } from './blocks/ai-chat-block/components/ai-chat-messages';
import { ChatImage, ChatImages, } from './blocks/ai-chat-block/components/chat-images';
...
import { CodeArtifactTool, CodeHighlighter, } from './components/ai-tools/code-artifact';
...
import { AIPanelAnswer, AIPanelDivider, AIPanelError, AIPanelGenerating, AIPanelInput, } from './widgets/ai-panel/components';
...
import { AFFINE_BLOCK_DIFF_WIDGET_FOR_BLOCK, AffineBlockDiffWidgetForBlock, } from './widgets/block-diff/block';
import { BlockDiffOptions } from './widgets/block-diff/options';
import { AFFINE_BLOCK_DIFF_WIDGET_FOR_PAGE, AffineBlockDiffWidgetForPage, } from './widgets/block-diff/page';
import { AFFINE_BLOCK_DIFF_PLAYGROUND, AFFINE_BLOCK_DIFF_PLAYGROUND_MODAL, BlockDiffPlayground, BlockDiffPlaygroundModal, } from './widgets/block-diff/playground';
import { AFFINE_EDGELESS_COPILOT_WIDGET, EdgelessCopilotWidget, } from './widgets/edgeless-copilot';
...
export function registerAIEffects() {
    ...
    customElements.define('ai-chat-embedding-status-tooltip', AIChatEmbeddingStatusTooltip);
    ...
    customElements.define('chat-panel-candidates-popover', ChatPanelCandidatesPopover);
    ...
    customElements.define('affine-edgeless-ai-chat', EdgelessAIChatBlockComponent);
    ...
    customElements.define('ai-scrollable-text-renderer', AIScrollableTextRenderer);
    ...
    customElements.define(AFFINE_BLOCK_DIFF_PLAYGROUND_MODAL, BlockDiffPlaygroundModal);
    ...
    customElements.define(AFFINE_BLOCK_DIFF_WIDGET_FOR_BLOCK, AffineBlockDiffWidgetForBlock);
    customElements.define(AFFINE_BLOCK_DIFF_WIDGET_FOR_PAGE, AffineBlockDiffWidgetForPage);
    customElements.define('edgeless-copilot-panel', EdgelessCopilotPanel);
    customElements.define('edgeless-copilot-toolbar-entry', EdgelessCopilotToolbarEntry);
