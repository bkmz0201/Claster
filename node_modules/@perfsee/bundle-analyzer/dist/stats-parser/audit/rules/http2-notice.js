...
exports.http2Notice = void 0;
const types_1 = require("../../types");
const http2Notice = ({ chunks }) => {
    ...
    return {
        ...
        score: initialAssets.size <= 6 ? types_1.BundleAuditScore.Good : types_1.BundleAuditScore.Notice,
        weight: 0,
    };
};
exports.http2Notice = http2Notice;
//# sourceMappingURL=http2-notice.js.map