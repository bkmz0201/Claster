...
export const useDeleteTagConfirmModal = () => {
    ...
    const confirm = useCallback((tagIdsToDelete) => {
        let closed = false;
        ...
        openConfirmModal({
            ...
            description: tagIdsToDelete.length === 1 ? (_jsx(Trans, { i18nKey: 'com.affine.delete-tags.confirm.description', values: { tag: tagName }, components: { 1: _jsx("strong", {}) } })) : (t['com.affine.delete-tags.confirm.multi-tag-description']({
