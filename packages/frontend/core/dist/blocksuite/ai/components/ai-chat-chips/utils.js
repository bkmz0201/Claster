...
import {} from 'lit';
export function getChipTooltip(state, name, tooltip) {
    if (tooltip) {
        return tooltip;
    }
    if (state === 'candidate') {
...
export function getChipIcon(state, icon) {
...
export function isDocChip(chip) {
    return 'docId' in chip;
}
export function isFileChip(chip) {
    return 'file' in chip && chip.file instanceof File;
}
export function isTagChip(chip) {
    return 'tagId' in chip;
}
export function isCollectionChip(chip) {
    return 'collectionId' in chip;
}
export function isSelectedContextChip(chip) {
...
export function getChipKey(chip) {
    if (isDocChip(chip)) {
        return chip.docId;
    }
    if (isFileChip(chip)) {
...
export function omitChip(chips, chip) {
...
export function findChipIndex(chips, chip) {
