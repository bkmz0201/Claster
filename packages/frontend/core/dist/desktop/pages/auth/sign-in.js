...
export const SignIn = ({ redirectUrl: redirectUrlFromProps, }) => {
    const t = useI18n();
    ...
    const handleAuthenticated = useCallback((status) => {
    ...
    return (_jsx(SignInPageContainer, { children: _jsx("div", { style: { maxWidth: '400px', width: '100%' }, children: _jsx(SignInPanel, { onSkip: handleClose, onAuthenticated: handleAuthenticated, initStep: initStep, server: server }) }) }));
};
export const Component = () => {
    return (_jsxs(AffineOtherPageLayout, { children: [_jsx(SignInBackgroundArts, {}), _jsx(SignIn, {})] }));
};
