import { defaultImageProxyMiddleware, docLinkBaseURLMiddleware, fileNameMiddleware, filePathMiddleware, MarkdownAdapter, titleMiddleware, } from '@blocksuite/affine-shared/adapters';
 ...
 */
async function importMarkdownZip({ collection, schema, imported, extensions, }) {
    const provider = getProvider(extensions);
