...
import { createRandomUser, enableCloudWorkspace, loginUser, } from '@affine-test/kit/utils/cloud';
...
test.describe('comments', () => {
    ...
    test('can create and display a comment on selected text', async ({ page, }) => {
        ...
        await page.keyboard.type('This is a test paragraph with some text that we will comment on.', { delay: 50 });
        for (let i = 0; i < 11; i++) {
        ...
        const commentButton = page.locator('editor-icon-button[aria-label="Comment"]');
        ...
        const commentEditor = page.locator('.comment-editor-viewport .page-editor-container');
        ...
        await expect(page.locator('text=This is my first comment on this text')).toBeVisible();
