...
import { getBlockSuiteEditorTitle, waitForEditorLoad, waitForEmptyEditor, } from '@affine-test/kit/utils/page-logic';
...
test('should transform local favorites data', async ({ page }) => {
    ...
    await expect(page
        ...
        .locator('[draggable] >> text=this is a new fav page')).toBeVisible();
