...
async function locateTag(scope, name) {
    return scope.locator(`[data-role="navigation-panel-tag"][aria-label="${name}"]`);
}
async function getNavigationPanelTagColor(tagNode) {
...
async function changeTagColor(scope, color) {
...
async function createRootTag(page, name, color = 'var(--affine-palette-line-red)') {
...
//# sourceMappingURL=explorer-tag.spec.js.map