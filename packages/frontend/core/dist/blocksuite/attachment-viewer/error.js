...
export const AttachmentFallback = ({ model, ext }) => {
    ...
    return (_jsx(ErrorBase, { icon: _jsx(Icon, {}), title: title, subtitle: subtitle, buttons: [
            _jsx(Button, { variant: "primary", prefix: _jsx(ArrowDownBigIcon, {}), onClick: () => {
...
const ErrorBoundaryInner = (props) => {
    ...
    return _jsx(ErrorBase, { title: title, subtitle: subtitle });
};
export const AttachmentPreviewErrorBoundary = (props) => {
    return (_jsx(ErrorBoundary, { FallbackComponent: ErrorBoundaryInner, children: _jsx(Suspense, { children: props.children }) }));
};
