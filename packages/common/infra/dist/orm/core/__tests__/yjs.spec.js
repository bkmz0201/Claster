...
import { beforeEach, describe, expect, test as vitest, } from 'vitest';
import { Doc } from 'yjs';
import { createORMClient, f, t, Table, YjsDBAdapter, } from '../';
...
describe('ORM entity CRUD', () => {
    ...
    test('can not use reserved keyword as field name', () => {
        expect(() => new YjsDBAdapter({
            tags: {
                $$DELETED: f.string().primaryKey().default(nanoid),
            },
        }, docProvider)).toThrow("[Table(tags)]: Field '$$DELETED' is reserved keyword and can't be used");
    });
...
//# sourceMappingURL=yjs.spec.js.map