...
import { RouteLogic, useNavigateHelper, } from '@affine/core/components/hooks/use-navigate-helper';
...
const LocalOnboardingAnimation = () => {
    return (_jsx("div", { className: styles.thumb, children: _jsx("video", { className: styles.thumbContent, src: "/onboarding/ai-onboarding.general.1.mp4", autoPlay: true, loop: true, muted: true, playsInline: true }) }));
};
export const AIOnboardingLocal = () => {
    ...
    useEffect(() => {
        ...
        timeoutRef.current = setTimeout(() => {
            ...
            const id = notify({
                title: (_jsx("div", { className: styles.title, children: t['com.affine.ai-onboarding.local.title']() })),
                message: t['com.affine.ai-onboarding.local.message'](),
                icon: _jsx(AiIcon, {}),
                iconColor: cssVar('brandColor'),
                thumb: _jsx(LocalOnboardingAnimation, {}),
                alignMessage: 'icon',
...
//# sourceMappingURL=local.dialog.js.map