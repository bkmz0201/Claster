...
import { Pagination, SettingRow, SettingWrapper, } from '@affine/component/setting-components';
...
const BillingHistorySkeleton = () => {
    const t = useI18n();
    return (_jsx(SettingWrapper, { title: t['com.affine.payment.billing-setting.history'](), children: _jsx("div", { className: styles.billingHistorySkeleton, children: _jsx(Loading, {}) }) }));
};
