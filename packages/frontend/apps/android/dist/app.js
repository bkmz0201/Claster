...
import { AuthProvider, AuthService, DefaultServerService, ServerScope, ServerService, ServersService, ValidatorProvider, } from '@affine/core/modules/cloud';
...
export function App() {
    return (_jsx(Suspense, { children: _jsx(FrameworkRoot, { framework: frameworkProvider, children: _jsx(I18nProvider, { children: _jsxs(AffineContext, { store: getCurrentStore(), children: [_jsx(ThemeProvider, {}), _jsx(RouterProvider, { fallbackElement: _jsx(AppFallback, {}), router: router, future: future })] }) }) }) }));
}
