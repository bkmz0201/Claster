...
import { BackgroundInlineSpecExtension, BoldInlineSpecExtension, CodeInlineSpecExtension, ColorInlineSpecExtension, InlineSpecExtensions, ItalicInlineSpecExtension, StrikeInlineSpecExtension, UnderlineInlineSpecExtension, } from '@blocksuite/affine/inlines/preset';
...
import { DefaultOpenDocExtension, DocDisplayMetaService, DocModeService, FileSizeLimitService, FontConfigExtension, fontConfigSchema, FontLoaderService, PageViewportServiceExtension, ThemeService, ToolbarRegistryExtension, } from '@blocksuite/affine/shared/services';
...
class CommentEditorViewExtensionProvider extends ViewExtensionProvider {
    constructor() {
        super(...arguments);
        this.name = 'comment-editor';
        this.schema = commentEditorViewExtensionOptionsSchema;
    }
...
let manager = null;
export function getCommentEditorViewManager(framework) {
    if (!manager) {
        ...
        manager.configure(LinkedDocViewExtension, createCommentLinkedWidgetConfig(framework));
