...
let EdgelessEditor = (() => {
    ...
    return class EdgelessEditor extends _classSuper {
        static {
  ...
  `; }
    ...
    `;
        ...
        willUpdate(changedProperties) {
            ...
            if (this.hasUpdated && // skip the first update
        ...
        #specs_accessor_storage = (__runInitializers(this, _editor_extraInitializers), __runInitializers(this, _specs_initializers, []));
