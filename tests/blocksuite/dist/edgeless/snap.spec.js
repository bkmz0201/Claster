...
import { createShapeElement, dragBetweenViewCoords, edgelessCommonSetup, Shape, } from '../utils/actions/edgeless.js';
...
test.describe('snap', () => {
    ...
    test('snapDistribute', async ({ page }) => {
        ...
        await dragBetweenViewCoords(page, [144 + 100 - 9, 100 - 9], [144 + 100 - 9 + 3, 100 - 9]);
        await assertSelectedBound(page, [150, 0, 100, 100]);
        await waitNextFrame(page);
    });
});
//# sourceMappingURL=snap.spec.js.map