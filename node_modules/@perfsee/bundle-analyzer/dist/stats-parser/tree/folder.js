...
const base_folder_1 = require("./base-folder");
const concatenated_module_1 = require("./concatenated-module");
const module_1 = require("./module");
const utils_1 = require("./utils");
class Folder extends base_folder_1.BaseFolder {
    get gzipSize() {
    ...
    addModule(moduleData) {
        const pathParts = (0, utils_1.getModulePathParts)(moduleData.realPath);
        if (!pathParts) {
            return;
        }
        const [folders, fileName] = [pathParts.slice(0, -1), (0, lodash_1.last)(pathParts)];
        ...
        const ModuleConstructor = moduleData.concatenating.length ? concatenated_module_1.ConcatenatedModule : module_1.Module;
