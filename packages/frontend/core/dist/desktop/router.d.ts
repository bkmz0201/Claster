export declare function RootRouter(): false | import("react/jsx-runtime").JSX.Element;
export declare const topLevelRoutes: [{
    element: import("react/jsx-runtime").JSX.Element;
    errorElement: import("react/jsx-runtime").JSX.Element;
    children: ({
        path: string;
        lazy: () => Promise<typeof import("./pages/index")>;
        loader?: undefined;
    } | {
        path: string;
        ...
        path: string;
        lazy: () => Promise<typeof import("./pages/invite")>;
        loader?: undefined;
    })[];
}];
