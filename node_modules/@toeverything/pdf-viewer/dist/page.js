export class Page {
    ...
    label() {
        ...
        const len1 = this.runtime.pageLabel(this.doc.pointer, this.index, bufferPtr, len0);
        if (len0 === len1) {
    ...
    render(bitmap, startX, startY, sizeX, sizeY, rotate, flags) {
        this.runtime.renderPageBitmap(bitmap.pointer, this.ptr, startX, startY, sizeX, sizeY, rotate, flags);
    }
    getPointFromDeviceToPage(deviceX, deviceY) {
        const startX = 0;
        const startY = 0;
        ...
        this.runtime.pointFromDeviceToPage(this.ptr, startX, startY, sizeX, sizeY, rotate, deviceX, deviceY, pageXPtr, pageYPtr);
    ...
    getPointFromPageToDevice(pageX, pageY) {
        const startX = 0;
        const startY = 0;
        const sizeX = this.width();
        const sizeY = this.height();
        ...
        this.runtime.pointFromPageToDevice(this.ptr, startX, startY, sizeX, sizeY, rotate, pageX, pageY, deviceXPtr, deviceYPtr);
