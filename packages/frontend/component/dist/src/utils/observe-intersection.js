...
if (typeof window !== 'undefined') {
    window._intersectionObserverElementsMap = elementsMap;
}
/**
 * @internal get or initialize the IntersectionObserver instance
 */
const getIntersectionObserver = () => (_intersectionObserver ??= new IntersectionObserver(entries => {
...
//# sourceMappingURL=observe-intersection.js.map