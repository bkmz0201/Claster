...
export type VirtualKeyboardProvider = (VirtualKeyboardEvent & VirtualKeyboardAction) | VirtualKeyboardEvent;
export declare const VirtualKeyboardProvider: import("@toeverything/infra").Identifier<VirtualKeyboardProvider> & ((variant: string) => import("@toeverything/infra").Identifier<VirtualKeyboardProvider>);
export {};
