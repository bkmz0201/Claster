...
exports.appendCacheInvalidation = void 0;
const utils_1 = require("../../../utils");
const types_1 = require("../../types");
// special audit
function appendCacheInvalidation(jobResult, baselineJobResult) {
    const baseAssetNames = new Set(baselineJobResult.assets.map((asset) => asset.name));
    ...
    jobResult.entryPoints.forEach((entryPoint) => {
        const missed = entryPoint.assetRefs.reduce((size, ref) => {
            ...
            return (0, utils_1.addSize)(size, asset.size);
        }, (0, utils_1.getDefaultSize)());
        const total = entryPoint.size;
        ...
        entryPoint.audits.push({
            ...
            desc: `Cache invalidation rate is up to ${Math.round(rawRate * 100)}%. Avoid naming changing with 'content hash' if their content is not changed.
If it's caused by dependencies version bumps, it can be safely ignored.`,
            score: rawRate >= 0.8 ? types_1.BundleAuditScore.Bad : rawRate >= 0.3 ? types_1.BundleAuditScore.Warn : types_1.BundleAuditScore.Good,
            detail: {
                type: 'table',
                headings: [
...
exports.appendCacheInvalidation = appendCacheInvalidation;
