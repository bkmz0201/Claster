...
import { BrowserWorkbenchNewTabHandler, DesktopWorkbenchNewTabHandler, WorkbenchNewTabHandler, } from './services/workbench-new-tab-handler';
import { DesktopWorkbenchDefaultState, InMemoryWorkbenchDefaultState, WorkbenchDefaultState, } from './services/workbench-view-state';
export function configureWorkbenchCommonModule(services) {
    services
...
export function configureBrowserWorkbenchModule(services) {
...
export function configureDesktopWorkbenchModule(services) {
    configureWorkbenchCommonModule(services);
    services
        .scope(WorkspaceScope)
