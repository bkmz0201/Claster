...
export type ReadwiseDocProperties = Omit<ReadwiseBook, 'highlights'> & ReadwiseHighlight;
export type ReadwiseBookMap = Record<ReadwiseBook['user_book_id'], Omit<ReadwiseBook, 'highlights'>>;
