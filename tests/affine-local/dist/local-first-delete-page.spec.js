...
import { clickNewPageButton, getBlockSuiteEditorTitle, getPageByTitle, getPageItem, getPageOperationButton, waitForEditorLoad, } from '@affine-test/kit/utils/page-logic';
import { getCurrentDocIdFromUrl } from '@affine-test/kit/utils/url';
import { expect } from '@playwright/test';
test('page delete -> refresh page -> it should be disappear', async ({ page, workspace, }) => {
...
test('page delete -> create new page -> refresh page -> new page should be appear -> old page should be disappear', async ({ page, workspace, }) => {
    test.slow();
    await openHomePage(page);
    await waitForEditorLoad(page);
    await clickNewPageButton(page);
...
test('delete multiple pages -> create multiple pages -> refresh', async ({ page, workspace, }) => {
    await openHomePage(page);
    await waitForEditorLoad(page);
    // create 1st page
    await clickNewPageButton(page);
...
//# sourceMappingURL=local-first-delete-page.spec.js.map