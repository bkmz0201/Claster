import { pressArrowDown, pressArrowUp, pressBackspace, pressEnter, } from '@affine-test/kit/utils/keyboard';
...
test('add callout block using slash menu and change emoji', async ({ page, }) => {
