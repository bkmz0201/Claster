...
import { embedSyncedDocMiddleware, HtmlAdapter, } from '@blocksuite/affine-shared/adapters';
...
describe('snapshot to html', () => {
  ...
  `
        ...
        if (title) {
            htmlTemplate = htmlTemplate.replace('<!--BlockSuiteDocTitlePlaceholder-->', `<h1>${title}</h1>`);
        }
        return htmlTemplate;
    };
    const paragraphTemplate = (html) => `<div class="affine-paragraph-block-container">${html}<div class="affine-block-children-container" style="padding-left: 26px;"></div></div>`;
    test('code', async () => {
        const blockSnapshot = {
            type: 'block',
            id: 'block:vu6SK6WJpW',
    ...
    test('bulleted list', async () => {
        ...
        const html = template(`<ul class="bulleted-list"><li class="affine-list-block-container">aaa<ul class="bulleted-list"><li class="affine-list-block-container">bbb<ul class="bulleted-list"><li class="affine-list-block-container">ccc</li></ul></li><li class="affine-list-block-container">ddd</li></ul></li><li class="affine-list-block-container">eee</li></ul>`);
        const htmlAdapter = new HtmlAdapter(createJob(), provider);
        const target = await htmlAdapter.fromBlockSnapshot({
            snapshot: blockSnapshot,
        });
    ...
    describe('embed link block', () => {
        ...
        for (const testCase of embedTestCases) {
            test(testCase.name, async () => {
                ...
                const html = template(`<div class="affine-paragraph-block-container"><a href="${testCase.url}">${testCase.title}</a></div>`);
                const htmlAdapter = new HtmlAdapter(createJob(), provider);
                const target = await htmlAdapter.fromBlockSnapshot({
                    snapshot: blockSnapshot,
                });
    ...
    test('linked doc block', async () => {
        ...
        const middleware = ({ adapterConfigs }) => {
            adapterConfigs.set('title:4T5ObMgEIMII-4Bexyta1', 'Test Doc');
            adapterConfigs.set('docLinkBaseUrl', 'https://example.com');
        };
        const html = template('<div class="affine-paragraph-block-container"><a href="https://example.com/4T5ObMgEIMII-4Bexyta1?mode=page&#x26;blockIds=abc%2C123&#x26;elementIds=def%2C456&#x26;databaseId=deadbeef&#x26;databaseRowId=123">Test Doc</a></div>');
    ...
    test('synced doc block', async () => {
        ...
        const syncedDocHtml = paragraphTemplate('<h1>Heading 1</h1>') +
        ...
        const docHtml = template(paragraphTemplate('<p>Hello</p>') +
            syncedDocHtml +
            '<div class="affine-paragraph-block-container"><p>Deepest Doc</p></div>' +
            paragraphTemplate('<p>World!</p>'), 'Test Doc');
...
describe('html to snapshot', () => {
  ...
  `.replace('<!--HtmlTemplate-->', html);
    ...
    test('inline div', async () => {
        const html = template(`<span>aaa</span><a href="https://www.google.com/">bbb</a><div style="display:inline">ccc</div>`);
        const blockSnapshot = {
            type: 'block',
            id: 'matchesReplaceMap[0]',
            flavour: 'affine:note',
    ...
    test('flex div', async () => {
        const html = template(`<div style="display:flex"><span>aaa</span><a href="https://www.google.com/">bbb</a><div>ccc</div></div>`);
        const blockSnapshot = {
            type: 'block',
            id: 'matchesReplaceMap[0]',
            flavour: 'affine:note',
    ...
    describe('strong element', () => {
        ...
        test('should be bold when font-weight is bold or 500-900 ', async () => {
            const html = template(`<p><span style="font-weight: bold;">aaa</span><span style="font-weight: 100;">aaa</span><span style="font-weight: 500;">bbb</span><span style="font-weight: 200;">bbb</span><span style="font-weight: 600;">ccc</span><span style="font-weight: 300;">ccc</span><span style="font-weight: 700;">ddd</span></p>`);
            const blockSnapshot = {
                type: 'block',
                id: 'matchesReplaceMap[0]',
                flavour: 'affine:note',
    ...
    test('should be italic when tag is i or em or span with style font-style: italic', async () => {
        const html = template(`<p><i>aaa</i><span>aaa</span><em>bbb</em><span>bbb</span><span style="font-style: italic;">ccc</span></p>`);
        const blockSnapshot = {
            type: 'block',
            id: 'matchesReplaceMap[0]',
            flavour: 'affine:note',
    ...
    test('should be underline when tag is u or span with style text-decoration: underline', async () => {
        const html = template(`<p><u>aaa</u><span>aaa</span><span style="text-decoration: underline;">bbb</span></p>`);
        const blockSnapshot = {
            type: 'block',
            id: 'matchesReplaceMap[0]',
            flavour: 'affine:note',
    ...
    test('should be strike when tag is del or span with style text-decoration: line-through', async () => {
        const html = template(`<p><del>aaa</del><span>aaa</span><span style="text-decoration: line-through;">bbb</span></p>`);
        const blockSnapshot = {
            type: 'block',
            id: 'matchesReplaceMap[0]',
            flavour: 'affine:note',
