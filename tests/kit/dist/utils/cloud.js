...
import { clickNewPageButton, waitForAllPagesLoad, waitForEditorLoad, } from '@affine-test/kit/utils/page-logic';
...
export async function getTokenFromLatestMailMessage(test) {
...
export async function getLoginCookie(context) {
...
export const runPrisma = async (cb) => {
...
export async function addUserToWorkspace(workspaceId, userId, permission) {
...
export async function switchDefaultChatModel(model) {
    await runPrisma(async (client) => {
...
export async function loginUser(page, user, config) {
...
export async function loginUserDirectly(page, user, config) {
...
export async function enableCloudWorkspace(page) {
...
export async function enableCloudWorkspaceFromShareButton(page) {
...
export async function enableShare(page) {
