...
const duplicateLibs = ({ packages }) => {
    const duplicatedPackages = new Map();
    const existedPackages = new Map();
    ...
    return {
        ...
        score: (0, utils_1.rangeScore)(duplicatedPackages.size, 0, 4),
        numericScore: {
...
exports.duplicateLibs = duplicateLibs;
//# sourceMappingURL=duplicate-libs.js.map