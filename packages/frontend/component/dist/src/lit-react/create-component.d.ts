 ...
 */
export type ReactWebComponent<I extends HTMLElement, E extends EventNames = EmptyObject> = React.ForwardRefExoticComponent<PropsWithoutRef<ComponentProps<I, E>> & React.RefAttributes<I>>;
type ElementProps<I> = Partial<Omit<I, keyof HTMLElement>>;
type ComponentProps<I, E extends EventNames = EmptyObject> = Omit<React.HTMLAttributes<I>, keyof E | keyof ElementProps<I>> & EventListeners<E> & ElementProps<I>;
/**
...
export interface Options<I extends HTMLElement, E extends EventNames = EmptyObject> {
    react: typeof React;
    tagName?: string;
 ...
 */
export declare const createComponent: <I extends HTMLElement, E extends EventNames = EmptyObject>({ react: React, tagName, elementClass, events, displayName, }: Options<I, E>) => ReactWebComponent<I, E>;
export {};
