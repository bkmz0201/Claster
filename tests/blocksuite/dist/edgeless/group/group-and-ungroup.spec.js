import { captureHistory, clickView, createShapeElement, edgelessCommonSetup, getFirstContainerId, getIds, redoByKeyboard, selectAllByKeyboard, Shape, shiftClickView, toIdCountMap, triggerComponentToolbarAction, undoByKeyboard, } from '../../utils/actions/index.js';
import { assertContainerChildCount, assertContainerChildIds, assertContainerIds, assertSelectedBound, } from '../../utils/asserts.js';
...
test.describe('group and ungroup in group', () => {
    ...
    test('ungroup in group', async ({ page }) => {
        ...
        await assertContainerChildIds(page, toIdCountMap(await getIds(page, true)), outterGroupId);
        ...
        await assertContainerChildIds(page, {
            [groupId]: 1,
            [newAddedShape]: 1,
        }, outterGroupId);
...
//# sourceMappingURL=group-and-ungroup.spec.js.map