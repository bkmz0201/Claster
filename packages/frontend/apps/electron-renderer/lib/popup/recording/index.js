...
export function Recording() {
    ...
    return (_jsxs("div", { className: styles.root, children: [_jsx("img", { className: styles.affineIcon, src: appIcon, alt: "AFFiNE" }), _jsx("div", { className: styles.text, children: textElement }), _jsx("div", { className: styles.controls, children: controlsElement })] }));
}
