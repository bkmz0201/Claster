...
const cls_plugins_module_1 = require("../plugin/cls-plugins.module");
...
let ClsModule = ClsModule_1 = class ClsModule {
    ...
    static forRoot(options) {
        return {
            module: ClsModule_1,
            imports: [
                cls_root_module_1.ClsRootModule.forRoot(options),
                ...cls_plugins_module_1.ClsPluginsModule.createPluginModules(options?.plugins),
            ],
    ...
    static forRootAsync(asyncOptions) {
        return {
            module: ClsModule_1,
            imports: [
                cls_root_module_1.ClsRootModule.forRootAsync(asyncOptions),
                ...cls_plugins_module_1.ClsPluginsModule.createPluginModules(asyncOptions.plugins),
            ],
    ...
    static registerPlugins(plugins) {
        return {
            module: ClsModule_1,
            imports: cls_plugins_module_1.ClsPluginsModule.createPluginModules(plugins),
        };
    }
};
