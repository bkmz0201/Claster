...
export type SettingTab = 'shortcuts' | 'notifications' | 'appearance' | 'about' | 'plans' | 'billing' | 'backup' | 'experimental-features' | 'editor' | 'account' | 'meetings' | `workspace:${'preference' | 'properties' | 'members' | 'storage' | 'billing' | 'license' | 'integrations' | 'embedding' | 'search'}`;
