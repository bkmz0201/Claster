    ...
    constructor(collection) {
        ...
        this.service = (service, ...[arg2]) => {
            if (arg2 instanceof Function) {
                ...
                this.collection.addFactory(service, dependenciesToFactory(service, arg2), { scope: this.currentScopeStack });
            }
            else {
        ...
        this.store = (store, ...[arg2]) => {
            if (arg2 instanceof Function) {
                ...
                this.collection.addFactory(store, dependenciesToFactory(store, arg2), { scope: this.currentScopeStack });
            }
            else {
        ...
        this.entity = (entity, ...[arg2]) => {
            if (arg2 instanceof Function) {
                ...
                this.collection.addFactory(entity, dependenciesToFactory(entity, arg2), { scope: this.currentScopeStack });
            }
            return this;
        };
        /**
        ...
        this.impl = (identifier, arg2, ...[arg3]) => {
            if (arg2 instanceof Function) {
                this.collection.addFactory(identifier, dependenciesToFactory(arg2, arg3), { scope: this.currentScopeStack });
            }
            else {
        ...
        this.override = (identifier, arg2, ...[arg3]) => {
            if (arg2 === null) {
                ...
                this.collection.addFactory(identifier, dependenciesToFactory(arg2, arg3), { scope: this.currentScopeStack, override: true });
            }
            else {
                this.collection.addValue(identifier, arg2, {
                    scope: this.currentScopeStack,
        ...
        this.scope = (scope) => {
            ...
            this.collection.addFactory(scope, dependenciesToFactory(scope, []), { scope: this.currentScopeStack, override: true });
            return this;
        };
    }
}
