...
declare type TableItemType = 'text' | 'size' | 'list' | 'link' | 'trace' | 'sideEffects';
...
export declare type ModuleSource = Record<string, [path: string, source: string]>;
