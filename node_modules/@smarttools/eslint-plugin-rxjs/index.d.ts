...
declare const rules: {
    'ban-observables': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", readonly Record<string, string | boolean>[], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    'ban-operators': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", readonly Record<string, string | boolean>[], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    finnish: import("@typescript-eslint/utils/ts-eslint").RuleModule<"shouldBeFinnish" | "shouldNotBeFinnish", readonly {
        functions?: boolean;
        methods?: boolean;
    ...
    'no-compat': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", [], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    ...
    'no-cyclic-action': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", readonly {
        observable?: string;
    }[], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    'no-exposed-subjects': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden" | "forbiddenAllowProtected", readonly {
    ...
    'no-implicit-any-catch': import("@typescript-eslint/utils/ts-eslint").RuleModule<"explicitAny" | "implicitAny" | "narrowed" | "suggestExplicitUnknown", readonly {
    ...
    'no-sharereplay': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden" | "forbiddenWithoutConfig", readonly {
        allowConfig?: boolean;
    }[], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    'no-subclass': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", [], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    ...
    'no-unsafe-catch': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", readonly {
        observable?: string;
    }[], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    'no-unsafe-first': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", readonly {
        observable?: string;
    }[], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    ...
    'no-unsafe-switchmap': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", readonly {
        allow?: string | string[];
        disallow?: string | string[];
        observable?: string;
    }[], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    'no-unsafe-takeuntil': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", readonly {
        alias?: string[];
        allow?: string[];
    }[], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    'prefer-observer': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", readonly {
        allowNext?: boolean;
    }[], unknown, import("@typescript-eslint/utils/ts-eslint").RuleListener>;
    'suffix-subjects': import("@typescript-eslint/utils/ts-eslint").RuleModule<"forbidden", readonly {
        parameters?: boolean;
        properties?: boolean;
        suffix?: string;
        types?: Record<string, boolean>;
