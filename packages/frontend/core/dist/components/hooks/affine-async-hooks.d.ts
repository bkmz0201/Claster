 ...
 */
export declare const AsyncCallbackContext: React.Context<AsyncErrorHandler>;
/**
 ...
 */
export declare function useAsyncCallback<T extends any[]>(callback: (...args: T) => Promise<void>, deps: DependencyList): (...args: T) => void;
//# sourceMappingURL=affine-async-hooks.d.ts.map