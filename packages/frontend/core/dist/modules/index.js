...
import { configureAIButtonModule, configureAIDraftModule, configureAIModelModule, configureAINetworkSearchModule, configureAIPlaygroundModule, configureAIReasoningModule, configureAIToolsConfigModule, } from './ai-button';
...
import { configureCommonGlobalStorageImpls, configureStorageModule, } from './storage';
...
export function configureCommonModules(framework) {
