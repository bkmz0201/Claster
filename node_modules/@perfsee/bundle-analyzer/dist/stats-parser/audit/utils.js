...
exports.computeCSSTokenLength = exports.computeJSTokenLength = exports.getDomain = exports.rangeScore = void 0;
const types_1 = require("../types");
function rangeScore(num, good = 0, warn = 3) {
    return num <= good ? types_1.BundleAuditScore.Good : num <= warn ? types_1.BundleAuditScore.Warn : types_1.BundleAuditScore.Bad;
}
...
function hasPunctuatorBefore(content, startPosition) {
    for (let i = startPosition; i > 0; i--) {
        ...
        if (WHITESPACE_REGEX.test(precedingCharacters))
            continue;
