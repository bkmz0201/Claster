...
export interface RadioItem {
    ...
    attrs?: Partial<Omit<React.HTMLAttributes<HTMLButtonElement>, 'className' | 'style'>> & Record<`data-${string}`, string>;
    customRender?: (item: Omit<RadioItem, 'customRender'>, index: number) => ReactNode;
}
export {};
