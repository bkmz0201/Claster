...
test('map test', { concurrency: false }, async (t) => {
    ...
    await t.test('y-octo to yjs compatibility test with nested type', () => {
        ...
        let sub_array2 = map2.get('array');
        let sub_map2 = map2.get('map');
        let sub_text2 = map2.get('text');
        assert(sub_array2);
    ...
    await t.test('yjs to y-octo compatibility test with nested type', () => {
        let doc2 = new Y.Doc();
        let map2 = doc2.getMap('map');
        let sub_array2 = new Y.Array();
        let sub_map2 = new Y.Map();
        ...
        let map = doc.getOrCreateMap('map');
        let sub_array = map.get('array');
        let sub_map = map.get('map');
        let sub_text = map.get('text');
        assert(sub_array);
...
//# sourceMappingURL=map.spec.mjs.map