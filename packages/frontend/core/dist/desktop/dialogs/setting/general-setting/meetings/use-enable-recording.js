...
export const useEnableRecording = () => {
    ...
    const t = useI18n();
    const handleEnabledChange = useAsyncCallback(async (checked) => {
        try {
            ...
            confirmModal.openConfirmModal({
                title: t['com.affine.settings.meetings.record.permission-modal.title'](),
                description: t['com.affine.settings.meetings.record.permission-modal.description'](),
                onConfirm: async () => {
                ...
                confirmText: t['com.affine.settings.meetings.record.permission-modal.open-setting'](),
            });
        }
    }, [confirmModal, meetingSettingsService, t]);
    return handleEnabledChange;
};
//# sourceMappingURL=use-enable-recording.js.map