...
function normalizeProfileChunkEnvelope(options, envelope, basePath) {
    ...
    const modifiedHeader = {
        ...originalHeader,
        sdk: { name: 'sentry.javascript.electron', version: version.SDK_VERSION },
    };
    let modifiedEnvelope = core.createEnvelope(modifiedHeader);
    ...
    core.forEachEnvelopeItem(envelope, (item, type) => {
        if (type === 'profile_chunk') {
            ...
            modifiedEnvelope = core.addItemToEnvelope(modifiedEnvelope, [headers, chunk]);
        }
    });
...
exports.normaliseProfileChunk = normaliseProfileChunk;
exports.normalizePaths = normalizePaths;
exports.normalizeProfileChunkEnvelope = normalizeProfileChunkEnvelope;
exports.normalizeReplayEnvelope = normalizeReplayEnvelope;
