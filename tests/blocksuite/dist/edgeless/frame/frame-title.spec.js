...
import { addNote, autoFit, createFrame as _createFrame, dragBetweenViewCoords, edgelessCommonSetup, getFrameTitle, getSelectedBound, toModelCoord, zoomOutByKeyboard, zoomResetByKeyboard, } from '../../utils/actions/edgeless.js';
import { pressBackspace, pressEnter, pressEscape, type, } from '../../utils/actions/keyboard.js';
...
const enterFrameTitleEditor = async (page) => {
...
test.describe('frame title rendering', () => {
    ...
    test('should not display frame title component when title is empty', async ({ page, }) => {
        const frame = await createFrame(page, [50, 50], [150, 150]);
...
//# sourceMappingURL=frame-title.spec.js.map