...
/** @internal */
export declare type _AsyncGeneratorVersionOf<T> = {
...
/** @internal */
export declare type _AsyncVersionOf<T> = {
 ...
 * @public
 */
export declare interface CallbackBasedChannel<Data = unknown> extends Partial<EventBasedChannel<Data>> {
    /**
 ...
 * @public
 */
export declare interface EventBasedChannel<Data = unknown> {
    /**
 ...
 */
export declare type _IgnoreResponse<T> = T extends (...args: infer Args) => unknown ? (...args: Args) => Promise<void> : {
 ...
 * @public
 */
export declare const JSONSerialization: (replacerAndReceiver?: [(((key: string, value: any) => any) | undefined)?, (((key: string, value: any) => any) | undefined)?], space?: string | number | undefined, undefinedKeepingBehavior?: 'keep' | 'null' | false) => Serialization;
 ...
 */
export declare const NoSerialization: Serialization;
