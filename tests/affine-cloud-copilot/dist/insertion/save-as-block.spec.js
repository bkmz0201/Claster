...
test.describe('AIInsertion/SaveAsBlock', () => {
    ...
    test('should save content as a chat block in page mode', async ({ loggedInPage: page, utils, }) => {
        await utils.chatPanel.openChatPanel(page);
    ...
    test('should save content as a chat block in edgeless mode', async ({ loggedInPage: page, utils, }) => {
...
//# sourceMappingURL=save-as-block.spec.js.map