import { ColorScheme, FontWeight, resolveColor, } from '@blocksuite/affine/model';
...
export const usePalettes = (originalPalettes, defaultColor, isShapeText = false) => {
    ...
    return {
        palettes,
        getCurrentColor: (color) => palettes.find(({ value }) => isEqual(value, color)) ||
