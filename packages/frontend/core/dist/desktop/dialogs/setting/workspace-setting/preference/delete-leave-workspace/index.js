...
export const DeleteLeaveWorkspace = ({ onCloseSetting, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(SettingRow, { name: _jsx("span", { style: { color: cssVarV2('status/error') }, children: isOwner
                        ? t['com.affine.workspaceDelete.title']()
                        : t['com.affine.deleteLeaveWorkspace.leave']() }), desc: t['com.affine.deleteLeaveWorkspace.description'](), style: { cursor: 'pointer' }, onClick: onLeaveOrDelete, "data-testid": "delete-workspace-button", children: _jsx(ArrowRightSmallIcon, {}) }), isOwner ? (_jsx(WorkspaceDeleteModal, { onConfirm: onDeleteConfirm, open: showDelete, onOpenChange: setShowDelete, workspaceMetadata: workspace.meta })) : (_jsx(ConfirmModal, { open: showLeave, cancelText: t['com.affine.confirmModal.button.cancel'](), onConfirm: onDeleteConfirm, onOpenChange: setShowLeave, title: `${t['com.affine.deleteLeaveWorkspace.leave']()}?`, description: t['com.affine.deleteLeaveWorkspace.leaveDescription'](), confirmText: t['Leave'](), confirmButtonOptions: {
                    variant: 'error',
                } }))] }));
};
