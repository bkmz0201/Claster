...
import { clickSideBarAllPageButton, clickSideBarSettingButton, clickSideBarUseAvatar, } from '@affine-test/kit/utils/sidebar';
...
test.describe('login first', () => {
    ...
    test('can see and change email and password in setting panel', async ({ page, }) => {
