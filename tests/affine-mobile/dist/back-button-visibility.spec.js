...
const locateBack = (page) => page.getByTestId('page-header-back');
test('new doc via app tab should not show back', async ({ page }) => {
    ...
    const docCard = page.locator(`[data-testid="doc-card"][data-doc-id="${docId}"]`);
    await docCard.click();
...
//   await expect(locateBack(page)).toBeVisible();
// });
//# sourceMappingURL=back-button-visibility.spec.js.map