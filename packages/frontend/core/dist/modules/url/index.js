...
export const configureUrlModule = (container) => {
    container.service(UrlService, f => new UrlService(f.getOptional(PopupWindowProvider), f.getOptional(ClientSchemeProvider)));
};
