...
function doLoadAutoUpdater() {
    ...
    if (process.platform === "win32") {
        ...
        try {
            ...
            console.warn("Unable to detect 'package-type' for autoUpdater (beta rpm/deb/pacman support). If you'd like to expand support, please consider contributing to electron-builder", error.message);
        }
    }
    return _autoUpdater;
}
