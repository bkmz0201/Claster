...
test('should create a page with a local first avatar and remove it', async ({ page, workspace, }) => {
    ...
    const avatarCanvas = await page
        ...
        .first()
        .elementHandle();
    const avatarPixelData = await page.evaluate(({ avatarCanvas }) => {
        return Array.from(avatarCanvas
            .getContext('2d')
...
//# sourceMappingURL=local-first-avatar.spec.js.map