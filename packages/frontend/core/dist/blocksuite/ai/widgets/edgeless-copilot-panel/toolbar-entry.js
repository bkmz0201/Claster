...
import { GfxControllerIdentifier, isGfxGroupCompatibleModel, } from '@blocksuite/affine/std/gfx';
...
let EdgelessCopilotToolbarEntry = (() => {
  ...
  `; }
        ...
        _showCopilotPanel() {
            ...
            this._gfx.tool.currentTool$.peek().updateSelectionWith(Array.from(toBeSelected), 10);
        }
        render() {
