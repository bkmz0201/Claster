...
import { z } from 'zod';
import { BlockDiffService, BlockDiffWatcher, } from '../../ai/services/block-diff';
...
export class AIViewExtension extends ViewExtensionProvider {
    constructor() {
        super(...arguments);
        this.name = 'affine-ai-view-extension';
    ...
    setup(context, options) {
        ...
        context
            ...
            .register(ToolbarModuleExtension({
