...
export const AppSidebarJournalButton = () => {
    ...
    return (_jsx(MenuLinkItem, { "data-testid": "slider-bar-journals-button", active: isJournal || location.pathname.startsWith('/journals'), to: '/journals', icon: _jsx(Icon, {}), children: t['com.affine.journal.app-sidebar-title']() }));
};
//# sourceMappingURL=journal-button.js.map