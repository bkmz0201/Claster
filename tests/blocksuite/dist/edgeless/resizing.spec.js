import { selectElementInEdgeless, switchEditorMode, zoomResetByKeyboard, } from '../utils/actions/edgeless.js';
import { addBasicBrushElement, addBasicRectShapeElement, clickView, dragBetweenCoords, enterPlaygroundRoom, initEmptyEdgelessState, pressBackspace, resizeElementByHandle, } from '../utils/actions/index.js';
import { assertEdgelessSelectedReactCursor, assertEdgelessSelectedRect, } from '../utils/asserts.js';
...
test.describe('resizing shapes and aspect ratio will be maintained', () => {
    test('positive adjustment', async ({ page }) => {
        ...
        await addBasicRectShapeElement(page, { x: 210, y: 210 }, { x: 310, y: 310 });
...
test.describe('cursor style', () => {
    test('editor is aligned at the start of viewport', async ({ page }) => {
        ...
        await switchEditorMode(page);
        await zoomResetByKeyboard(page);
        await addBasicRectShapeElement(page, { x: 200, y: 200 }, { x: 300, y: 300 });
