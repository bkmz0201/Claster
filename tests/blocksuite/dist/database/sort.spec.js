...
import { enterPlaygroundRoom, initDatabaseDynamicRowWithData, initEmptyDatabaseState, waitNextFrame, } from '../utils/actions/index.js';
...
test('database sort with multiple rules', async ({ page }) => {
    ...
    const getCellText = async (row, index) => {
