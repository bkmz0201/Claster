...
export declare abstract class DocSyncStorageBase implements DocSyncStorage {
    readonly storageType = "docSync";
    abstract readonly connection: Connection;
    abstract getPeerRemoteClock(peer: string, docId: string): Promise<DocClock | null>;
    ...
    abstract getPeerPulledRemoteClock(peer: string, docId: string): Promise<DocClock | null>;
    abstract getPeerPulledRemoteClocks(peer: string): Promise<DocClocks>;
    abstract setPeerPulledRemoteClock(peer: string, clock: DocClock): Promise<void>;
    abstract getPeerPushedClock(peer: string, docId: string): Promise<DocClock | null>;
