...
test.describe('AIChatWith/Attachments', () => {
    ...
    test('support chat with attachment', async ({ loggedInPage: page, utils, }) => {
    ...
    test('support chat with multiple attachments', async ({ loggedInPage: page, utils, }) => {
...
//# sourceMappingURL=attachments.spec.js.map