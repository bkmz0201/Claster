...
export function configureCollectionRulesModule(framework) {
    framework
        ...
        .impl(FilterProvider('property:docPrimaryMode'), DocPrimaryModeFilterProvider, [DocsService])
        .impl(FilterProvider('system:docPrimaryMode'), DocPrimaryModeFilterProvider, [DocsService])
        ...
        .impl(FilterProvider('system:integrationType'), IntegrationTypeFilterProvider, [DocsService])
        .impl(FilterProvider('property:edgelessTheme'), EdgelessThemeFilterProvider, [DocsService])
        ...
        .impl(GroupByProvider('property:checkbox'), CheckboxPropertyGroupByProvider, [DocsService])
        ...
        .impl(GroupByProvider('property:docPrimaryMode'), DocPrimaryModeGroupByProvider, [DocsService])
        .impl(GroupByProvider('system:docPrimaryMode'), DocPrimaryModeGroupByProvider, [DocsService])
        ...
        .impl(GroupByProvider('system:integrationType'), IntegrationTypeGroupByProvider, [DocsService])
        .impl(GroupByProvider('property:edgelessTheme'), EdgelessThemeGroupByProvider, [DocsService])
        .impl(GroupByProvider('system:edgelessTheme'), EdgelessThemeGroupByProvider, [DocsService])
        ...
        .impl(OrderByProvider('property:docPrimaryMode'), DocPrimaryModeOrderByProvider, [DocsService])
        .impl(OrderByProvider('system:docPrimaryMode'), DocPrimaryModeOrderByProvider, [DocsService])
        ...
        .impl(OrderByProvider('property:checkbox'), CheckboxPropertyOrderByProvider, [DocsService])
        ...
        .impl(OrderByProvider('system:integrationType'), IntegrationTypeOrderByProvider, [DocsService])
        .impl(OrderByProvider('property:edgelessTheme'), EdgelessThemeOrderByProvider, [DocsService])
        .impl(OrderByProvider('system:edgelessTheme'), EdgelessThemeOrderByProvider, [DocsService])
