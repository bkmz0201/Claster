...
let ChatPanelTagChip = (() => {
    ...
    return class ChatPanelTagChip extends _classSuper {
        constructor() {
            super(...arguments);
            ...
            this.#tag_accessor_storage = (__runInitializers(this, _removeChip_extraInitializers), __runInitializers(this, _tag_initializers, void 0));
            this.onChipDelete = (__runInitializers(this, _tag_extraInitializers), () => {
        ...
        static {
            ...
            _tag_decorators = [property({ attribute: false })];
