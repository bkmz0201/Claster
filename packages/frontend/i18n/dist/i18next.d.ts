...
export declare const getOrCreateI18n: () => i18n;
...
export type I18nString = KnownI18nKey | string | {
    i18nKey: string;
    options?: Record<string, any>;
};
export declare function isI18nString(value: unknown): value is I18nString;
export declare function createI18nWrapper(getI18nFn: () => i18n): {
    t(key: I18nString, options?: Record<string, any>): string;
