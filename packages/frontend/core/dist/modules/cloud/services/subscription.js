...
let SubscriptionService = (() => {
    ...
    var SubscriptionService = class extends _classSuper {
        ...
        constructor(store) {
            super();
            this.store = store;
            this.subscription = this.framework.createEntity(Subscription);
            this.prices = this.framework.createEntity(SubscriptionPrices);
