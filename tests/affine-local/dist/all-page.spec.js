...
import { clickNewPageButton, getAllPage, getBlockSuiteEditorTitle, waitForAllPagesLoad, waitForEditorLoad, } from '@affine-test/kit/utils/page-logic';
...
test('select two pages and delete', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="floating-toolbar"]')).toHaveText('2 doc(s) selected');
    // click delete button
...
test('select three pages with shiftKey and delete', async ({ page }) => {
    ...
    // the floating popover should appear
    await expect(page.locator('[data-testid="floating-toolbar"]')).toBeVisible();
    await expect(page.locator('[data-testid="floating-toolbar"]')).toHaveText('3 doc(s) selected');
    // click delete button
    await page.locator('[data-testid="list-toolbar-delete"]').click();
    // the confirm dialog should appear
...
//# sourceMappingURL=all-page.spec.js.map