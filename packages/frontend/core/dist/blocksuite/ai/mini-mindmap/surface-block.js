...
import { CanvasRenderer, } from '@blocksuite/affine/blocks/surface';
...
let MindmapSurfaceBlock = (() => {
    ...
    return class MindmapSurfaceBlock extends _classSuper {
        ...
        _setupCenterEffect() {
            this._disposables.add(this.mindmapService.requestCenter.subscribe(() => {
                let bound;
        ...
        _setupRenderer() {
            this._disposables.add(this.model.elementUpdated.subscribe(() => {
