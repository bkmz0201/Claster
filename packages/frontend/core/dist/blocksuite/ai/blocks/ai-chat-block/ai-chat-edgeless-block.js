...
export class EdgelessAIChatBlockComponent extends toGfxBlockComponent(AIChatBlockComponent) {
    renderGfxBlock() {
...
export const EdgelessAIChatBlockInteraction = GfxViewInteractionExtension(AIChatBlockSchema.model.flavour, {
    resizeConstraint: {
        minWidth: 260,
        minHeight: 160,
        maxWidth: 320,
...
//# sourceMappingURL=ai-chat-edgeless-block.js.map