...
export declare abstract class AwarenessStorageBase implements AwarenessStorage {
    readonly storageType = "awareness";
    abstract readonly connection: Connection;
    abstract update(record: AwarenessRecord, origin?: string): Promise<void>;
    abstract subscribeUpdate(id: string, onUpdate: (update: AwarenessRecord, origin?: string) => void, onCollect: () => Promise<AwarenessRecord | null>): () => void;
}
