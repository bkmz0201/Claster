...
export function registerAffineNavigationCommands({ t, docCollection, navigationHelper, workspaceDialogService, workbenchService, }) {
    const unsubs = [];
...
//# sourceMappingURL=affine-navigation.js.map