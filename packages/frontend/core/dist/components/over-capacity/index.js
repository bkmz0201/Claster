...
export const OverCapacityNotification = () => {
    ...
    useEffect(() => {
        const disposableOverCapacity = currentWorkspace.engine.blob.state$.subscribe(debounce(({ overCapacity }) => {
            ...
            if (isOwner) {
                notify.warning({
                    ...
                    message: t['com.affine.payment.storage-limit.new-description.owner'](),
                    actions: [
                        {
                            key: 'upgrade',
                ...
                notify.warning({
                    title: t['com.affine.payment.storage-limit.new-title'](),
                    message: t['com.affine.payment.storage-limit.description.member'](),
                });
            }
        }));
        return () => {
