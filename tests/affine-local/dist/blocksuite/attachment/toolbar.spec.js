...
import { importAttachment, importFile, } from '@affine-test/kit/utils/attachment';
import { clickEdgelessModeButton, clickView, locateToolbar, toViewCoord, } from '@affine-test/kit/utils/editor';
import { openHomePage } from '@affine-test/kit/utils/load-page';
import { clickNewPageButton, getBlockSuiteEditorTitle, waitForEmptyEditor, } from '@affine-test/kit/utils/page-logic';
...
test.describe('Replaces attachment', () => {
    ...
    test('should fall back to card view when file type does not support embed view', async ({ page, }) => {
        const title = getBlockSuiteEditorTitle(page);
        await title.click();
        await page.keyboard.press('Enter');
        await importAttachment(page, 'lorem-ipsum.pdf');
