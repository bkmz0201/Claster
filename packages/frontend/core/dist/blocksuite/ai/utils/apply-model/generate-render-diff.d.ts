import { type Block } from './markdown-diff';
 ...
 * ```
 */
export declare function generateRenderDiff(originalMarkdown: string, changedMarkdown: string): RenderDiffs;
//# sourceMappingURL=generate-render-diff.d.ts.map