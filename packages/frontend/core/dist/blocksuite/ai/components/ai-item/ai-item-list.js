...
import { EditorHost, PropTypes, requiredProperties, } from '@blocksuite/affine/std';
  ...
  `; }
        ...
        ${group.name
              ...
              ${group.name.toLocaleUpperCase()}
                    ...
                    : nothing}
        ${repeat(group.items, item => item.name, item => html `<ai-item
              .theme=${theme}
      ...
      ></ai-sub-item-list>`,
            ...
            this.#testId_accessor_storage = (__runInitializers(this, _onClick_extraInitializers), __runInitializers(this, _testId_initializers, 'ai-item-list'));
