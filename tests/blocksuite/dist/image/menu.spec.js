...
import { dragBetweenCoords, enterPlaygroundRoom, initImageState, } from '../utils/actions/index.js';
...
test('select image should not show format bar', async ({ page }) => {
    ...
    await dragBetweenCoords(page, { x: rect.x - 20, y: rect.y + 20 }, { x: rect.x + 20, y: rect.y + 40 });
