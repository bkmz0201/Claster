...
import { createRandomUser, deleteUser, enableCloudWorkspace, getLoginCookie, loginUser, runPrisma, } from '@affine-test/kit/utils/cloud';
...
test.skip('migration', async ({ page, browser }) => {
    let workspaceId;
    {
        ...
        await runPrisma(async (client) => {
            const sqls = (await readFile(Path.dir(import.meta.url).join('fixtures', '0.9.0-canary.9-snapshots.sql').value, 'utf-8'))
...
//# sourceMappingURL=migration.spec.skip.js.map