...
test.describe('AIInsertion/Insert', () => {
    ...
    test('should insert content below selected block in page mode', async ({ loggedInPage: page, utils, }) => {
        // Create tow blocks
        // - Hello Block
        // - World Block
    ...
    test('should insert content below selected block in edgeless mode', async ({ loggedInPage: page, utils, }) => {
    ...
    test('should insert content at the end of the page when no block is selected', async ({ loggedInPage: page, utils, }) => {
        // Create tow blocks
        // - Hello Block
        // - World Block
        await utils.editor.focusToEditor(page);
    ...
    test('should insert content at the end of the note when no block is selected in edgeless mode', async ({ loggedInPage: page, utils, }) => {
        await utils.editor.switchToEdgelessMode(page);
        await utils.editor.focusToEditor(page);
        await page.keyboard.insertText('Hello Block');
        await page.keyboard.press('Enter');
    ...
    test('should create a new note when no block or note is selected in edgeless mode', async ({ loggedInPage: page, utils, }) => {
        await utils.editor.switchToEdgelessMode(page);
        // Delete default note
