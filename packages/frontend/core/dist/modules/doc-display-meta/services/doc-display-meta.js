...
import { AliasIcon as LitAliasIcon, BlockLinkIcon as LitBlockLinkIcon, EdgelessIcon as LitEdgelessIcon, LinkedEdgelessIcon as LitLinkedEdgelessIcon, LinkedPageIcon as LitLinkedPageIcon, PageIcon as LitPageIcon, TodayIcon as LitTodayIcon, TomorrowIcon as LitTomorrowIcon, YesterdayIcon as LitYesterdayIcon, } from '@blocksuite/icons/lit';
import { AliasIcon, BlockLinkIcon, EdgelessIcon, LinkedEdgelessIcon, LinkedPageIcon, PageIcon, TodayIcon, TomorrowIcon, YesterdayIcon, } from '@blocksuite/icons/rc';
...
const icons = { rc: rcIcons, lit: litIcons };
export class DocDisplayMetaService extends Service {
    constructor(journalService, docsService, i18nService, explorerIconService) {
        super();
        this.journalService = journalService;
        this.docsService = docsService;
        this.i18nService = i18nService;
        this.explorerIconService = explorerIconService;
    }
    getJournalIcon(journalDate, options) {
    ...
    title$(docId, options) {
        return LiveData.computed(get => {
            ...
            // doc not found
            if (!doc) {
                return this.i18nService.i18n.i18next.t('com.affine.notFoundPage.title', { lng });
            }
            // original title
            if (originalTitle)
...
//# sourceMappingURL=doc-display-meta.js.map