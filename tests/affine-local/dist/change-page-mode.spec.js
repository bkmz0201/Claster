...
import { ensureInEdgelessMode, ensureInPageMode, getPageMode, } from '@affine-test/kit/utils/editor';
import { openHomePage } from '@affine-test/kit/utils/load-page';
import { clickNewPageButton, clickPageMoreActions, getBlockSuiteEditorTitle, waitForAllPagesLoad, waitForEditorLoad, } from '@affine-test/kit/utils/page-logic';
...
test('default to edgeless by editor header items', async ({ page }) => {
    ...
    const docItem = page.locator(`[data-testid="doc-list-item"]:has-text("this is a new page")`);
...
test('Clearing out the title bar will remove the page title', async ({ page, }) => {
    await openHomePage(page);
    await waitForEditorLoad(page);
    const titleBarTextContent = page.getByTestId('title-edit-button');
    await titleBarTextContent.dblclick({ delay: 100 });
...
//# sourceMappingURL=change-page-mode.spec.js.map