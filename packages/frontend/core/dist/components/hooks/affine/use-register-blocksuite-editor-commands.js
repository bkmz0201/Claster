...
import { EdgelessIcon, HistoryIcon, LocalWorkspaceIcon, PageIcon, } from '@blocksuite/icons/rc';
...
export function useRegisterBlocksuiteEditorCommands(editor, active) {
    ...
    useEffect(() => {
        ...
        const unsubs = [];
        const preconditionStrategy = () => PreconditionStrategy.InPaperOrEdgeless && !trash;
        ...
        unsubs.push(registerAffineCommand({
            ...
            preconditionStrategy: () => PreconditionStrategy.InPaperOrEdgeless && !trash,
            category: `editor:${mode}`,
            icon: mode === 'page' ? _jsx(PageIcon, {}) : _jsx(EdgelessIcon, {}),
        ...
        unsubs.push(registerAffineCommand({
            id: `editor:${mode}-convert-to-${mode === 'page' ? 'edgeless' : 'page'}`,
            preconditionStrategy,
            category: `editor:${mode}`,
            icon: mode === 'page' ? _jsx(PageIcon, {}) : _jsx(EdgelessIcon, {}),
            label: `${t['Convert to ']()}${mode === 'page'
        ...
        unsubs.push(registerAffineCommand({
            ...
            async run() {
                ...
                doc.record.setProperty('pageWidth', checked ? 'standard' : 'fullWidth');
            },
        }));
...
//# sourceMappingURL=use-register-blocksuite-editor-commands.js.map